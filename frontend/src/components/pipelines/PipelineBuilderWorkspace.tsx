...
function WorkspaceSkeleton() {
  return (
    ...
    >
      <div className="shrink-0 border-b border-hairline p-2 xl:w-[var(--sidebar-width)] xl:border-b-0 xl:border-r">
    ...
    <PageBody className="flex flex-col">
      {loading ? (
        ...
        >
          ...
          <div className="flex max-h-[38vh] min-h-0 shrink-0 flex-col border-b border-hairline xl:max-h-none xl:w-[var(--sidebar-width)] xl:border-b-0 xl:border-r">
