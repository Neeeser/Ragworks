...
import { useConnectionNotice } from "./hooks/use-connection-notice";
...
export function PipelineBuilder({ kind }: PipelineBuilderProps) {
  ...
  const connectionNotice = useConnectionNotice();
  ...
  const { connecting, validateConnection, handleConnect, handleConnectStart, handleConnectEnd } =
    useConnectionTyping({
      ...
      edges,
      setEdges,
      onFeedback: connectionNotice.report,
    });
    ...
    <PipelineEditorContext.Provider value={editorHandle}>
      ...
      <PipelineBuilderWorkspace
        ...
        canvas={{
          ...
          connectionNotice: connectionNotice.notice,
          onConnectionNoticeDismiss: connectionNotice.dismiss,
